...
export class CourseT2 extends Cource{
    ...
    nominations: Nomination[] = [
        ...
        { id: 5, name: 'Мужская мастера – Салонная мода  (комбинированный вид)', price: 2000, isSelected: false,
        parts: 
        ['Салонная прическа (на манекен-головке)', 
        'Салонная стрижка (на манекен-головке)']},
        { id: 6, name: 'Женские мастера – (индивидуальный вид)', price: 1500, isSelected: false,
        parts: 
